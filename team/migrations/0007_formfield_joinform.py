    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('describe_list', wagtail.core.fields.StreamField([('list', wagtail.core.blocks.ListBlock(wagtail.core.blocks.CharBlock(icon='list-ul', label='Пункт списка', template='blocks/list_block.html')))])),
            ],
            options={
                'abstract': False,
            },
